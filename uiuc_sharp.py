...
class Thermochemistry:
    ...
    def __init__(self, usr_np=np):
        ...
        self.usr_np = usr_np
        self.model_name = 'mechs/uiuc_sharp.yaml'
        self.num_elements = 4
        self.num_species = 7
    ...
    def get_species_viscosities(self, temperature):
        return self.usr_np.sqrt(temperature)*self._pyro_make_array([
                (0.0005643720009284571 + -0.0008536047562446639*self.usr_np.log(temperature) + 0.00034065536407341777*self.usr_np.log(temperature)**2 + -4.2648038931472564e-05*self.usr_np.log(temperature)**3 + 1.7934368018097565e-06*self.usr_np.log(temperature)**4)**2,
                (-0.006186428071784459 + 0.003618824512265024*self.usr_np.log(temperature) + -0.0006861983404519474*self.usr_np.log(temperature)**2 + 5.916012709644184e-05*self.usr_np.log(temperature)**3 + -1.9049771784433379e-06*self.usr_np.log(temperature)**4)**2,
                (-0.0027060422317322606 + 0.00099608913488712*self.usr_np.log(temperature) + -3.245759288262185e-05*self.usr_np.log(temperature)**2 + -9.15207993467064e-06*self.usr_np.log(temperature)**3 + 6.716178143243158e-07*self.usr_np.log(temperature)**4)**2,
                (-0.00521608145079593 + 0.003111199674194881*self.usr_np.log(temperature) + -0.0005939529792207282*self.usr_np.log(temperature)**2 + 5.162313384558195e-05*self.usr_np.log(temperature)**3 + -1.6749040550313004e-06*self.usr_np.log(temperature)**4)**2,
                (0.009495196334954333 + -0.004974400618445216*self.usr_np.log(temperature) + 0.0009719845681945996*self.usr_np.log(temperature)**2 + -7.63468726049601e-05*self.usr_np.log(temperature)**3 + 2.0741201775470118e-06*self.usr_np.log(temperature)**4)**2,
                (-0.00032862351581974033 + 0.00047402944328694686*self.usr_np.log(temperature) + -8.852339013643083e-05*self.usr_np.log(temperature)**2 + 8.188000383424178e-06*self.usr_np.log(temperature)**3 + -2.775116846661831e-07*self.usr_np.log(temperature)**4)**2,
                (-0.005232503458857859 + 0.003124981120246175*self.usr_np.log(temperature) + -0.0005968857242794555*self.usr_np.log(temperature)**2 + 5.190839695047409e-05*self.usr_np.log(temperature)**3 + -1.6850989392761648e-06*self.usr_np.log(temperature)**4)**2,
                ])
    ...
    def get_species_thermal_conductivities(self, temperature):
        return self.usr_np.sqrt(temperature)*self._pyro_make_array([
                0.18385271624866842 + -0.09812050654864941*self.usr_np.log(temperature) + 0.01871067923066944*self.usr_np.log(temperature)**2 + -0.0014894434590280682*self.usr_np.log(temperature)**3 + 4.220932619231024e-05*self.usr_np.log(temperature)**4,
                0.10689552101630528 + -0.06376711343770658*self.usr_np.log(temperature) + 0.014217756178712414*self.usr_np.log(temperature)**2 + -0.0013908411531386269*self.usr_np.log(temperature)**3 + 5.09174438888175e-05*self.usr_np.log(temperature)**4,
                0.0871088646655998 + -0.05136577647286977*self.usr_np.log(temperature) + 0.011079892418410776*self.usr_np.log(temperature)**2 + -0.0010291064627698154*self.usr_np.log(temperature)**3 + 3.531690263236322e-05*self.usr_np.log(temperature)**4,
                0.04060029461887554 + -0.020985470902516137*self.usr_np.log(temperature) + 0.00400137335308852*self.usr_np.log(temperature)**2 + -0.00032019801523515564*self.usr_np.log(temperature)**3 + 9.270576537591015e-06*self.usr_np.log(temperature)**4,
                -0.40448952246714476 + 0.25166528584206543*self.usr_np.log(temperature) + -0.05823800028133604*self.usr_np.log(temperature)**2 + 0.005930903658833211*self.usr_np.log(temperature)**3 + -0.00022233754286936298*self.usr_np.log(temperature)**4,
                -0.9677034329303261 + 0.5744337660316912*self.usr_np.log(temperature) + -0.12573711513496563*self.usr_np.log(temperature)**2 + 0.012123569772975705*self.usr_np.log(temperature)**3 + -0.0004317820757905789*self.usr_np.log(temperature)**4,
                0.0026129214099176023 + 0.001593238644698187*self.usr_np.log(temperature) + -0.0009842775277398488*self.usr_np.log(temperature)**2 + 0.00016507154037197767*self.usr_np.log(temperature)**3 + -8.29731531537306e-06*self.usr_np.log(temperature)**4,
                ])
